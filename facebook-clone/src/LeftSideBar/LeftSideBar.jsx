      ...
      <div className="text-md bg-[#000] w-[30%] p-[2%] flex flex-col gap-[20px] text-white ">
        ...
        <div>
            ...
            <div className="friend-request-section">
              <span>
                <img className="friend-request-image" src="./assets/Images/deke4.jpeg" alt="" />
              </span>
            ...
            <div className="birthday-section">
                ...
                <span className="celebrant-info">
                  <img className="birthday-img" src="./assets/Images/birthday.jpg" alt=""/>
          ...
          <div className="contacts">
            ...
            <div className="contacts-online">
              <img className="contacts-online-img" src="./assets/Images/deke.jpeg" alt="" />
              <h3>Dayos' babe</h3>
            </div>
          </div>
        </div>
